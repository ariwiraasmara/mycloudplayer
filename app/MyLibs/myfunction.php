...
class myfunction {
    ...
    public static function enval(String|float $str, bool $we = false) {
    ...
    public static function setOneCookie(String $name = 'token', String|float|bool $val=1, $hari=1, $jam=24, $menit=60, $detik=60) {
    ...
    // OTHER
    public static function random(String $str = '', int $length = 7) {
        try {
            $seed = match($str) {
